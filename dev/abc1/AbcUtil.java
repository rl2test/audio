...
public class AbcUtil {
	/** The log. */
	private static Logger log = Logger.getLogger(AbcUtil.class);	
	 ...
	 * @return
	 */
	public static String standardToAbcNotation(String note) {
		String abcNote = "";
		if (note.length() == 1) {
			abcNote = note;
		} else {
	 ...
	 * @return
	 */
	public static String abcToStandardNotation(String abcNote) {
		String note = "";
